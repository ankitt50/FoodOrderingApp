...
public class CategoryControllerTest {
  ...
  //
  //    //This test case passes when you have handled the exception of trying to fetch any category
  // by its id, while there
  ...
  //
  //    //This test case passes when you are able to fetch the list of all categories ordered by
  // their name.
  @Test
