...
public class AddressControllerTest {
    ...
    mockMvc
        .perform(
            post("/address")
                ...
                .content(
                    "{\"flat_building_name\":\"xyz\", \"locality\":\"abc\", \"city\":\"pqr\", \"pincode\":\"282005\", \"state_uuid\":\"testUUID\"}"))
  ...
  public void shouldDeleteAddress() throws Exception {
    ...
    when(mockAddressService.deleteAddress(addressEntity, customerEntity))
        .thenReturn(deletedAddressEntity);
  ...
  //
  //    //This test case passes when you have handled the exception of trying to delete an address
  // with non existing access-token.
  @Test
  ...
  //
  //    //This test case passes when you are not able to retrive any states if there are no states
