...
public class RestaurantController {
  ...
  public ResponseEntity<RestaurantListResponse> getRestaurantsByName(
    ...
    List<RestaurantEntity> restaurants =
        allRestaurants.stream()
            .filter(r -> r.getRestaurantName().toLowerCase().contains(restaurantName.toLowerCase()))
  ...
  @GetMapping(
      ...
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
  public ResponseEntity<RestaurantListResponse> getRestaurantsByCategoryUuid(
      @PathVariable(name = "category_id") final String categoryUuid)
  ...
  @GetMapping(
      ...
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
  public ResponseEntity<RestaurantDetailsResponse> getRestaurantByUuid(
      @PathVariable(name = "restaurant_id") final String restaurantUuid)
      throws RestaurantNotFoundException {
  ...
  public ResponseEntity<RestaurantUpdatedResponse> updateRatingByRestaurantId(
      ...
      @RequestParam(name = "customer_rating") final Double givenCustomerRating,
      @PathVariable(name = "restaurant_id") final String restaurantUuid)
    ...
    if (givenCustomerRating == null || givenCustomerRating < 1 || givenCustomerRating > 5)
    ...
    RestaurantUpdatedResponse restUpd =
        new RestaurantUpdatedResponse(); /* Response entity created by Swagger plugin */
  ...
  private RestaurantListResponse getRestaurantListResponseFromRestaurantEntity(
      List<RestaurantEntity> restaurants) {
